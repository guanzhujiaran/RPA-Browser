# 内置动作映射常量
from app.models.database.workflow.models import ActionMetadata, BuiltinActionType
...
AllActionType = ClickAction | InputAction | ScrollAction | WaitAction | HoverAction | NavigateAction | NewPageAction | ScreenshotAction | LLMAction | LoopAction | IfElseAction
...
def get_all_actions_metadata() -> list[Type[AllActionType]]:
    """获取所有注册的动作类"""
